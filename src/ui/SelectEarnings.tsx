...
const SelectEarnings: React.FC<SelectEarningsProps> = ({ control, name, options, errors, required }) => {
    return (
        <>
                ...
                render={({ field: { onChange, value } }) => (
                    ...
                    >
                        ...
                        {options?.map((option: any) => (
                            <option key={option._id} className="text-black" value={option.value}>
                                {option.value}
                            </option>
                        ))}
                    </select>
