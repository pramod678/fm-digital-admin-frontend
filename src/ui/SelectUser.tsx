...
const SelectUser: React.FC<SelectUserProps> = ({ control, name, options, errors, required }) => {
                ...
                render={({ field: { onChange, value } }) => (
                    ...
                    >
                        ...
                        {options?.map((option: any) => (
                            <option key={option._id} className="text-black" value={option.users_id}>
                                {option?.users_id + " - " +option?.fname + " " + option?.lname}
                            </option>
                        ))}
                    </select>
                )}
