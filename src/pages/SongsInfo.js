...
const SongsInfo = () => {
  ...
  function handlegenregGet() {
    fetch(
      `https://backend.fmdigitalofficial.com/api/v1/createRelease/genreGet`,
      {
        method: "GET",
      }
    )
  ...
  function handleLanguageGet() {
    fetch(
      `https://backend.fmdigitalofficial.com/api/v1/createRelease/languageGet`,
      {
        method: "GET",
      }
    )
  ...
  const handleSubmit = async (event) => {
    ...
    const res = await fetch(
      "https://backend.fmdigitalofficial.com/api/v1/createRelease/songsInfoPost",
      {
        method: "POST",
        body: formData,
      }
