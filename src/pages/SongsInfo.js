...
const SongsInfo = () => {
  ...
  function handlegenregGet() {
    fetch(
      `http://3.108.3.213:5000/api/v1/createRelease/genreGet`,
      {
        method: "GET",
      }
    )
  ...
  function handleLanguageGet() {
    fetch(
      `http://3.108.3.213:5000/api/v1/createRelease/languageGet`,
      {
        method: "GET",
      }
    )
  ...
  const handleSubmit = async (event) => {
    ...
    const res = await fetch(
      "http://3.108.3.213:5000/api/v1/createRelease/songsInfoPost",
      {
        method: "POST",
        body: formData,
      }
