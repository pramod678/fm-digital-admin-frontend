...
const ReleseInfo = () => {
  ...
  function handlegenregGet() {
    fetch(`http://192.168.29.202:5000/api/v1/createRelease/genreGet`, {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleSubmit1 = async (e) => {
    fetch("http://192.168.29.202:5000/api/v1/createRelease/primaryArtistPost", {
      method: "POST",
      crossDomain: true,
      headers: {
        "Content-Type": "application/json",
  ...
  const handleSubmit2 = async (e) => {
    fetch(
      "http://192.168.29.202:5000/api/v1/createRelease/featuringArtisttPost",
      {
        method: "POST",
        crossDomain: true,
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch(
      "http://192.168.29.202:5000/api/v1/createRelease/releseInfoPost",
      {
        method: "POST",
        body: formData,
      }
