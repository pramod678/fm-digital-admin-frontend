...
const ReleseInfo = () => {
  ...
  function handlegenregGet() {
    fetch(`https://fmditital-1585723686.ap-south-1.elb.amazonaws.com/api/v1/createRelease/genreGet`, {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleSubmit1 = async (e) => {
    fetch("https://fmditital-1585723686.ap-south-1.elb.amazonaws.com/api/v1/createRelease/primaryArtistPost", {
      method: "POST",
      crossDomain: true,
      headers: {
        "Content-Type": "application/json",
  ...
  const handleSubmit2 = async (e) => {
    fetch(
      "https://fmditital-1585723686.ap-south-1.elb.amazonaws.com/api/v1/createRelease/featuringArtisttPost",
      {
        method: "POST",
        crossDomain: true,
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch(
      "https://fmditital-1585723686.ap-south-1.elb.amazonaws.com/api/v1/createRelease/releseInfoPost",
      {
        method: "POST",
        body: formData,
      }
