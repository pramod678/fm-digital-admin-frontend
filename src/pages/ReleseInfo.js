...
const ReleseInfo = () => {
  ...
  useEffect(() => {
    fetch("https://backend.fmdigitalofficial.com/api/v1/user/userData", {
      method: "POST",
      crossDomain: true,
      headers: {
  ...
  function handlegenregGet() {
    fetch(`https://backend.fmdigitalofficial.com/api/v1/createRelease/genreGet`, {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  function handlereleseInfoGetOne(userData) {
    fetch(
      `https://backend.fmdigitalofficial.com/api/v1/createRelease/releseInfoGetOne/${userData.users_id}`,
      {
        method: "GET",
      }
    )
  ...
  function handleArtistGet() {
    fetch(
      `https://backend.fmdigitalofficial.com/api/v1/createRelease/primaryArtistGet/${userData.users_id}`,
      {
        method: "GET",
      }
    )
  ...
  function handleFeacturingGet() {
    fetch(
      `https://backend.fmdigitalofficial.com/api/v1/createRelease/featuringArtisttGet/${userData.users_id}`,
      {
        method: "GET",
      }
    )
  ...
  const handleSubmit1 = async (e) => {
    fetch("https://backend.fmdigitalofficial.com/api/v1/createRelease/primaryArtistPost", {
      method: "POST",
      crossDomain: true,
      headers: {
        "Content-Type": "application/json",
  ...
  const handleSubmit2 = async (e) => {
    fetch(
      "https://backend.fmdigitalofficial.com/api/v1/createRelease/featuringArtisttPost",
      {
        method: "POST",
        crossDomain: true,
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch(
      "https://backend.fmdigitalofficial.com/api/v1/createRelease/releseInfoPost",
      {
        method: "POST",
        body: formData,
      }
