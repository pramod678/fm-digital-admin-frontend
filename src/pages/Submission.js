...
const Submission = () => {
  ...
  function handlesubmissionGet(userData) {
    ...
    fetch(
      `https://backend.fmdigitalofficial.com/api/v1/createRelease/submissionGet/${userData.users_id}`,
      {
        method: "GET",
      }
    )
  ...
  const handleSubmit = async (e) => {
    fetch(
      "https://backend.fmdigitalofficial.com/api/v1/createRelease/submissionPost",
      {
        method: "POST",
        crossDomain: true,
        headers: {
