...
const ProfileLinking = () => {
  ...
  function handleProfileLinkinAdudiogGet() {
    // console.log("userData.user_id",userData);
    fetch(
      `https://backend.fmdigitalofficial.com/api/v1/tools/profileLinkinAdudiogGet/users_id/${releseInfoGetOne.users_id}/releseInfo_id/${releseInfoGetOne.releseInfo_id}`,
      {
        method: "GET",
      }
    )
  ...
  function handleprofileLinkingGetAll(userData) {
    // console.log("userData.user_id",userData);
    fetch(
      `https://backend.fmdigitalofficial.com/api/v1/tools/profileLinkingGetAll/${userData.users_id}`,
      {
        method: "GET",
      }
    )
  ...
  const handleSubmit = async (e) => {
    fetch("https://backend.fmdigitalofficial.com/api/v1/tools/profileLinkingPost", {
      method: "POST",
      crossDomain: true,
      headers: {
        "Content-Type": "application/json",
