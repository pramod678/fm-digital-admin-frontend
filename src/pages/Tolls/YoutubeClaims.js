...
const YoutubeClaims = () => {
  ...
  function handleyoutubeClaimsGetAll(userData) {
    // console.log("userData.user_id",userData);
    fetch(
      `https://backend.fmdigitalofficial.com/api/v1/tools/youtubeClaimsGetAll/${userData.users_id}`,
      {
        method: "GET",
      }
    )
  ...
  const handleSubmit = async (e) => {
    fetch("https://backend.fmdigitalofficial.com/api/v1/tools/youtubeClaimsPost", {
      method: "POST",
      crossDomain: true,
      headers: {
        "Content-Type": "application/json",
