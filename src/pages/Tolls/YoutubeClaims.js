...
const YoutubeClaims = () => {
  ...
  function handleyoutubeClaimsGetAll(userData) {
    // console.log("userData.user_id",userData);
    fetch(
      `https://fmdigitalofficial.infmdigitalofficial.inapi/v1/tools/youtubeClaimsGetAll/${userData.users_id}`,
      {
        method: "GET",
      }
    )
  ...
  const handleSubmit = async (e) => {
    fetch("https://fmdigitalofficial.infmdigitalofficial.inapi/v1/tools/youtubeClaimsPost", {
      method: "POST",
      crossDomain: true,
      headers: {
        "Content-Type": "application/json",
