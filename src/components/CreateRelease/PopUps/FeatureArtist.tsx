                                ...
                                <form onSubmit={(e: any) => {
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <div className="w-full mb-2">
                                            <Label text="Featuring Artist Name" htmlFor="grid-firstName" />
                                            <InputField
                                                type="text"
                                        ...
                                        <div className="w-full mb-2">
                                            ...
                                            <InputField
                                                ...
                                                register={register}
                                                errors={errors}
                                                requiredMessage="Featuring Artist Apple Id  is required."
                                            />
                                        </div>
                                        ...
                                        <div className="w-full mb-2">
                                            ...
                                            <InputField
                                                ...
                                                register={register}
                                                errors={errors}
                                                requiredMessage="Featuring Artist Spotify Id  is required."
                                            />
                                        </div>
                                    </div>
