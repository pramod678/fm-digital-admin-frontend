        ...
        return (
            <>
                {[1, 2, 3, 4, 5].map((_, index) => (
                    <div key={index} className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm flex flex-col justify-between aspect-square relative">
                        ...
                        <div key={index} className="bg-gradient-to-b from-white to-[#e2dcf9] border border-gray-400 rounded-2xl p-4 shadow-sm flex flex-col justify-between aspect-square relative group hover:shadow-md transition-all">
                             ...
                             <div className="flex gap-3">
                                 ...
                                 <div className="flex flex-col mt-1 overflow-hidden">
                                     ...
                                     <p className="text-gray-600 text-xs font-medium uppercase tracking-wider mt-0.5 truncate">
                                        {data?.artist || "Artist"}
                                     </p>
                                 </div>
                             </div>
                             ...
                             <div className="flex flex-col gap-2 mt-auto">
                                 ...
                                 <div className="flex items-center justify-between mt-1">
                                     <div className="flex items-center gap-3 text-gray-500">
                                         ...
                                         <BiDotsHorizontalRounded size={20} className="cursor-pointer hover:text-gray-800" />
                                     </div>
