...
import UserHistoryTableListRow from "./ListRow";



export default function UserHistoryTable({ labelData }: { labelData: any }) {
                                                    ...
                                                    labelData?.map((data: any, index: any) => {
                                                        return (
                                                            <React.Fragment key={index}>
                                                                <UserHistoryTableListRow data={data} index={index} />
                                                            </React.Fragment>
                                                        )
                                                    })
                                                }
