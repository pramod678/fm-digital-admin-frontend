...
const AdminPrimaryArtistIndex = ({ setShowPrimaryArtist }: { setShowPrimaryArtist: any }) => {
    ...
    const dummyData = [
        {
            ...
            InstagramId: 'https://instagram.com/johndoe',
            FacebookId: 'https://facebook.com/johndoe',
            SpotifyId: 'https://spotify.com/artist/1',
            AppleId: 'https://music.apple.com/artist/1',
        ...
        },
        {
            primaryArtist_id: 2,
            users_id: 'USR002',
            PrimaryArtist: 'Jane Smith',
            InstagramId: '',
            FacebookId: 'https://facebook.com/janesmith',
            SpotifyId: 'https://spotify.com/artist/2',
            AppleId: '',
        ...
        },
        {
            primaryArtist_id: 3,
            users_id: 'USR003',
            PrimaryArtist: 'The Rockstars',
            InstagramId: 'https://instagram.com/rockstars',
            FacebookId: '',
            SpotifyId: '',
            AppleId: 'https://music.apple.com/artist/3',
            createdAt: '2023-10-03T09:15:00Z',
            users: [{ fname: 'Mike', lname: 'Johnson', email: 'mike@rockstars.com' }]
        }
    ];

    const displayData = GetPrimaryArtist?.data?.data && GetPrimaryArtist.data.data.length > 0 
        ? GetPrimaryArtist.data.data 
        : dummyData;
    ...
    const handleFilter = (e: any) => {
        ...
        const filtered = displayData.filter((item: any) =>
            item.PrimaryArtist.toLowerCase().includes(value) ||
        ...
        <>
            ...
            <div className="px-8 pt-8">
                <div className="flex items-center justify-between mb-2">
                    <h1 className="text-2xl typo-section-title tracking-tight">Primary Artists</h1>
                </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-4 mb-6">
                    ...
                    <div className="flex items-center gap-6">
                        <button 
                            ...
                            onClick={() => setShowPrimaryArtist(false)}
                        >
                            <span className="text-white typo-btn-main">Go To Featuring Artist</span>
                            <FiChevronRight className="text-white group-hover:translate-x-0.5 transition-transform" />
                        </button>
                    ...
                    <div className="overflow-x-auto">
                        ...
                        <thead className="bg-[#fcfdfd] border-b border-gray-100">
                            <tr>
                                ...
                                <th scope="col" className="px-2 py-3 text-center typo-table-head w-10">
                                    IG
                                </th>
                                <th scope="col" className="px-2 py-3 text-center typo-table-head w-10">
                                    FB
                                ...
                                <th scope="col" className="px-3 py-3 text-center typo-table-head w-32">
                                    Created At
                                </th>
                            </tr>
                        </thead>
                                    <tbody className="bg-white divide-y divide-gray-50">
                                        {
                                            records.length === 0 ? (
                                                <tr className="w-full">
                                                    <td className="text-center py-4 typo-table-cell" colSpan={11}>
                                                        No artists found.
                                                    </td>
                                                </tr>
                                            ) : (
                                                records && records.map((data: any, index: any) => (
                                                    <ListRow 
                                                        key={data.primaryArtist_id || index} 
                                                        data={data} 
                                                        index={index} 
