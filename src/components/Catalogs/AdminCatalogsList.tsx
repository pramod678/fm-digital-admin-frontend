...
import AdminVideoListRow from "./AdminVideoListRow";
...
/*
  ============================================================
  UI-ONLY MOCK DATA — MUST BE REMOVED WHEN BACKEND IS LIVE
  // BACKEND NOTE: API contracts must remain unchanged.
  // BACKEND NOTE: Filters, pagination, and data hydration are backend responsibilities.
  ============================================================
*/
const DUMMY_CATALOG_DATA = [
  {
    ...
    Status: 1,
    userData: [{ fname: "Ram", lname: "Kumar", email: "User@gmail.com" }],
    LabelName: "Label Name",
    songInfo: [{ Title: "Track 1", ISSRC: "INO-458-2014" }],
  ...
  },
  {
    ...
    LabelName: "Label Name",
    songInfo: [{ Title: "Track Name", ISSRC: "INO-458-2014" }],
  ...
  },
  {
    ...
    LabelName: "Label Name",
    songInfo: [{ Title: "Audio Title", ISSRC: "INO-458-2014" }],
...
export default function AdminCatalogsList() {
  ...
  // BACKEND NOTE: Filters and search should be passed as query params. No frontend filtering.
  ...
  return (
    <div className="flex flex-col h-full bg-white min-h-screen">
      ...
      */}
      ...
      {/* Page Title - Exact mockup */}
      <div className="px-4 pt-3 pb-2">
        <h1 className="typo-page-title flex items-center gap-1.5">
          <FaPlay className="w-3 h-3 text-gray-700" /> Video Catalog
        </h1>
      </div>

      <div className="px-4 space-y-3">
        {/* Summary Strip - Exact mockup: lavender gradient background */}
        <div className="bg-gradient-to-r from-pink-50 via-purple-50 to-pink-50 rounded px-4 py-2 flex items-center justify-between">
          
          {/* Left: Green "Go to Audio Catalog" button + pink divider + large 5 */}
          <div className="flex items-center gap-3">
            <button
              onClick={() => navigate("/CatalogsAudio")}
        ...
        {/* Filter Row - Exact mockup: dense, utilitarian */}
